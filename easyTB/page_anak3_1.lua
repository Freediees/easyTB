...
function scene:create( event )
	...
	local options = {
     ...
     local tabel = display.newImageRect( composer.imgDir.. "table1.png", 537, 526 ); 
    ...
    local options = {
     ...
     y_now = teks2.y + teks2.height + 10
      ...
      local a2 = display.newText("1", composer.tab2,y_now, used_font, 12  * (display.contentWidth / 320) )
    a2:setFillColor(0.2)
    a2.anchorX = 0
    a2.anchorY = 0
    scrollView:insert(a2)
    ...
    local options = {
         text = "Foto toraks menunjukkan gambaran efusi pleura atau milier atau kavitas",
         x = composer.textTab2,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
     ...
     local a2 = display.newText("2", composer.tab2,y_now, used_font, 12  * (display.contentWidth / 320) )
    a2:setFillColor(0.2)
    a2.anchorX = 0
    a2.anchorY = 0
    scrollView:insert(a2)
    ...
    local options = {
     ...
     local a2 = display.newText("3", composer.tab2,y_now, used_font, 12  * (display.contentWidth / 320) )
    a2:setFillColor(0.2)
    a2.anchorX = 0
    a2.anchorY = 0
    scrollView:insert(a2)
    ...
    local options = {
     ...
     local options = {
         text = "- Kejang dan kaku kuduk",
         x = composer.textTab2 + 20,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
         align = "left",
     ...
     local options = {
         text = "- Kegawatan lain, missal sesak napas",
         x = composer.textTab2 + 20,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local options = {
         text = "Bila BB kurang, diberikan upaya perbaikan gizi dan dievaluasi selama 1 bulan",
         x = composer.textTab2,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local options = {
         text = "Demam (≥2 minggu) dan batuk (≥3 minggu) saat imunisasi BCG",
         x = composer.textTab2,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local options = {
         text = "Alur tata laksana TB anak di layanan primer:",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
     ...
     local logo = display.newImageRect( composer.imgDir.. "grafik2.png", 268, 249 ); 
    logo.x = display.contentCenterX;
    logo.y =  y_now + tinggi/20
    logo.anchorY = 0
    logo.anchorX = 0.5
    --logo:scale(0.5,0.5)
    ...
    scrollView:insert(logo)
     ...
     y_now = logo.y + logo.height

     local garis = display.newLine(0, y_now + 30,lebar,y_now + 30)
