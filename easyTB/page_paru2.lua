...
function scene:create( event )
    ...
    local options = {
         text = "Kasus dengan riwayat pengobatan sebelumnya : ",
         x = composer.textTab1,
         y = y_now,
         font = used_font_bold,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local a4 = display.newText("a).", composer.tab2,y_now, used_font, 12  * (display.contentWidth / 320) )
    a4:setFillColor(0.2)
    a4.anchorX = 0
    a4.anchorY = 0
    ...
    local a4 = display.newText("b).", composer.tab2,y_now, used_font, 12  * (display.contentWidth / 320) )
    a4:setFillColor(0.2)
    a4.anchorX = 0
    a4.anchorY = 0
    scrollView:insert(a4)
	...
	local options = {
     ...
     y_now = teks4.y + teks4.height + 10
      ...
      local a5 = display.newText("c).", composer.tab2,y_now, used_font, 12  * (display.contentWidth / 320) )
    a5:setFillColor(0.2)
    a5.anchorX = 0
    a5.anchorY = 0
    ...
    local a6 = display.newText("d).", composer.tab2,y_now, used_font, 12  * (display.contentWidth / 320) )
    a6:setFillColor(0.2)
    a6.anchorX = 0
    a6.anchorY = 0
    ...
    local a7 = display.newText("e).", composer.tab2,y_now, used_font, 12  * (display.contentWidth / 320) )
    a7:setFillColor(0.2)
    a7.anchorX = 0
    a7.anchorY = 0
    ...
    local a8 = display.newText("f).", composer.tab2,y_now, used_font, 12  * (display.contentWidth / 320) )
    a8:setFillColor(0.2)
    a8.anchorX = 0
    a8.anchorY = 0
