...
function scene:create( event )
	...
	local options = {
		 text = "Klasifikasi berdasarkan lokasi anatomi",
         x = lebar * 0.05,
         y = 10,
         font = used_font_bold,
	...
	local options = {
     ...
     local a2 = display.newText("2.", composer.tab1,teks_produk_diskon.y + teks_produk_diskon.height + 10, used_font, 12  * (display.contentWidth / 320) )
    a2:setFillColor(0.2)
    a2.anchorX = 0
    a2.anchorY = 0
