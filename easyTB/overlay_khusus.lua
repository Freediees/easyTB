...
function scene:create( event )
	...
	local text_header = display.newText("Tuberkulosis pada Kebutuhan Khusus", menu.x + menu.width*menu.xScale + 10, menu.y, used_font_bold,11  * (display.contentWidth / 320))
	...
	local options = {
     ...
     local options = {
		 text = "Tuberkulosis Paru dengan Diabetes Mellitus", 
         x = 10,
     ...
     local options = {
         text = "Tuberkulosis pada Geriatri", 
         x = 10,
	...
	teks1:addEventListener("tap", toKhusus1)
