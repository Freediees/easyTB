...
function scene:create( event )
	...
	local options = {
     ...
     scrollView:insert(teks_produk_diskon);
 	 ...
 	 local a1 = display.newText("1.", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a1:setFillColor(0.2)
    a1.anchorX = 0
    a1.anchorY = 0
    scrollView:insert(a1)
     ...
     y_now = teks3.y + teks3.height + 10
      ...
      local a1 = display.newText("2.", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a1:setFillColor(0.2)
    a1.anchorX = 0
    a1.anchorY = 0
    scrollView:insert(a1)
     ...
     local a1 = display.newText("3.", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a1:setFillColor(0.2)
    a1.anchorX = 0
    a1.anchorY = 0
    scrollView:insert(a1)
     ...
     local a1 = display.newText("4.", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a1:setFillColor(0.2)
    a1.anchorX = 0
    a1.anchorY = 0
    scrollView:insert(a1)
     ...
     local a1 = display.newText("5.", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a1:setFillColor(0.2)
    a1.anchorX = 0
    a1.anchorY = 0
    scrollView:insert(a1)
    ...
    --[[ local a1 = display.newText("7.", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a1:setFillColor(0.2)
    a1.anchorX = 0
    a1.anchorY = 0
    scrollView:insert(a1)
--]]
     ...
     local options = {
         text = "Produksi cairan seresbropinal (m/.jam)",
         x = lebar/4,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
     ...
     local options = {
         text = "Produksi cairan seresbropinal (m/.jam) Volume cairan serebrospinal (ml)",
         x = lebar/2,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
     ...
     scrollView:insert(teks4);
      ...
      local options = {
         text = "Jumlah cairan serebrospinal yang aman untuk diambil untuk pungsi lumbal",
         x = lebar/4 * 3,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
