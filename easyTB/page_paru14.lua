...
function scene:create( event )
	...
	local options = {
		 text = "Suspek TB Resisten Obat", x = lebar * 0.05,
         y = 10,
         font = used_font_bold,
...
--]]
	...
	local options = {
     ...
     local a3 = display.newText("2", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a3:setFillColor(0.2)
    a3.anchorX = 0
    a3.anchorY = 0
    ...
    local options = {
     ...
     local a4 = display.newText("3", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a4:setFillColor(0.2)
    a4.anchorX = 0
    a4.anchorY = 0
    ...
    local options = {
     ...
     y_now = teks4.y + teks4.height + 10
      ...
      local a5 = display.newText("4", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a5:setFillColor(0.2)
    a5.anchorX = 0
    a5.anchorY = 0
    ...
    local options = {
     ...
     local a6 = display.newText("5", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a6:setFillColor(0.2)
    a6.anchorX = 0
    a6.anchorY = 0
    ...
    local options = {
     ...
     y_now = teks6.y + teks6.height + 10
      ...
      local a7 = display.newText("6", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a7:setFillColor(0.2)
    a7.anchorX = 0
    a7.anchorY = 0
    ...
    local options = {
     ...
     y_now = teks7.y + teks7.height + 10
       ...
       local a8 = display.newText("7", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a8:setFillColor(0.2)
    a8.anchorX = 0
    a8.anchorY = 0
    ...
    local a9 = display.newText("8", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a9:setFillColor(0.2)
    a9.anchorX = 0
    a9.anchorY = 0
    ...
    local options = {
     ...
     y_now = teks9.y + teks9.height + 10
      ...
      local a9 = display.newText("9", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a9:setFillColor(0.2)
    a9.anchorX = 0
    a9.anchorY = 0
    scrollView:insert(a9)
