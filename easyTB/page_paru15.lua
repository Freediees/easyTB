...
function scene:create( event )
	...
	local options = {
		 text = "Strategi Pengobatan TB Resisten Obat Ganda", x = lebar * 0.05,
         y = 10,
         font = used_font_bold,
...
--]]
	local options = {
		 text = "Beberapa strategi pengobatan TB resisten obat ganda:",
         x = composer.tab1,
