...
function scene:create( event )
   ...
   --[[ local a1 = display.newText("-", composer.tab1,teks_latar.y + teks_latar.height + 5, used_font, 12  * (display.contentWidth / 320) )
    ...
    local options = {
         text = "Istilah dalam kasus TB anak:",
         x = composer.tab1,
    ...
    y_now = teks2.y + teks2.height + 10
      ...
      local a3 = display.newText("2", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a3:setFillColor(0.2)
    a3.anchorX = 0
    a3.anchorY = 0
    ...
    y_now = teks3.y + teks3.height + 10
       ...
       local a4 = display.newText("3", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a4:setFillColor(0.2)
    a4.anchorX = 0
    a4.anchorY = 0
   ...
   --[[ local a4 = display.newText("3", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    ...
    local options = {
         text = "Penentuan klasifikasi dan tipe kasus TB anak harus ditulis sesuai urutan sbb:",
         x = composer.tab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local options = {
         text = "A. Lokasi atau organ tubuh yang terkena",
         x = composer.tab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local options = {
     ...
     local options = {
         text = "B. Pemeriksaan Bakteriologis:",
         x = composer.tab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    y_now = teks10.y + teks10.height + 10
      ...
      local a9 = display.newText("1", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a9:setFillColor(0.2)
    a9.anchorX = 0
    a9.anchorY = 0
    scrollView:insert(a9)
    ...
    local options = {
     ...
     y_now = teks11.y + teks11.height + 10
       ...
       local a12 = display.newText("2", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a12:setFillColor(0.2)
    a12.anchorX = 0
    a12.anchorY = 0
    scrollView:insert(a12)

    local options = {
         text = composer.anak3_7,
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local a13 = display.newText("-", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    ...
    local a14 = display.newText("-", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    ...
    local options = {
     ...
     local options = {
         text = "C. Riwayat Pengobatan Sebelumnya:",
         x = composer.tab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local a16 = display.newText("1", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    ...
    local options = {
     ...
     y_now = teks16.y + teks16.height + 10
       ...
       local a17 = display.newText("2", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    ...
    local options = {
     ...
     local options = {
         text = "D. Berat dan ringannya penyakit",
         x = composer.tab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local a19 = display.newText("1", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    ...
    local options = {
     ...
     y_now = teks19.y + teks19.height + 10
       ...
       local a20 = display.newText("2", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    ...
    local a22 = display.newText("1", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a22:setFillColor(0.2)
    a22.anchorX = 0
    a22.anchorY = 0
    scrollView:insert(a22)

    local options = {
         text = composer.anak3_15,
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local options = {
     ...
     y_now = teks23.y + teks23.height + 10
      ...
      local a24 = display.newText("2", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a24:setFillColor(0.2)
    a24.anchorX = 0
    a24.anchorY = 0
    scrollView:insert(a24)

    local options = {
         text = composer.anak3_17,
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
