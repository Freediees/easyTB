...
function scene:create( event )
	...
	local options = {
		 text = "Pengawasan dan Ketaatan Pasien dalam Pengobatan OAT", x = lebar * 0.05,
         y = 10,
         font = used_font_bold,
...
--]]
	...
	local options = {
		 text = "Komitmen pemerintah untuk menjalankan program TB nasional.",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local options = {
         text = "Penemuan kasus TB dengan pemeriksaan BTA mikroskopis.",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local options = {
         text = "Pemberian obat jangka pendek yang diawasi secara langsung.",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local options = {
         text = "Pengadaan OAT secara berkesinambungan.",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local options = {
         text = "Monitoring serta pencatatan dan pelaporan yang baku/standar.",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
