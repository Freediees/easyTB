...
function scene:create( event )
	...
	local options = {
		 text = "Pencatatan dan Pelaporan Program Penanggulangan TB", x = lebar * 0.05,
         y = 10,
         font = used_font_bold,
...
--]]
	...
	local options = {
		 text = "TB.01 : KARTU PENGOBATAN PASIEN",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
     ...
     local a3 = display.newText("-", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a3:setFillColor(0.2)
    a3.anchorX = 0
    a3.anchorY = 0
    ...
    local options = {
         text = "TB.02 : KARTU IDENTITAS PASIEN",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
     ...
     local a4 = display.newText("-", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a4:setFillColor(0.2)
    a4.anchorX = 0
    a4.anchorY = 0
    ...
    local options = {
         text = "TB.03 : REGISTER TB SARANA PELAYANAN KESEHATAN",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
     ...
     y_now = teks4.y + teks4.height + 10
      ...
      local a5 = display.newText("-", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a5:setFillColor(0.2)
    a5.anchorX = 0
    a5.anchorY = 0
    ...
    local options = {
         text = "TB.04 : REGISTER LABORATORIUM",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
     ...
     local a6 = display.newText("-", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a6:setFillColor(0.2)
    a6.anchorX = 0
    a6.anchorY = 0
    ...
    local options = {
         text = "TB.05 : FORMULIR PERMOHONAN LABORATORIUM TB UNTUK PEMERIKSAAN DAHAK",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
     ...
     y_now = teks6.y + teks6.height + 10
      ...
      local a7 = display.newText("-", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a7:setFillColor(0.2)
    a7.anchorX = 0
    a7.anchorY = 0
    ...
    local options = {
         text = "TB.06 : DAFTAR TERSANGKA PASIEN (SUSPEK) YANG DIPERIKSADAHAK SPS",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
     ...
     y_now = teks7.y + teks7.height + 10
       ...
       local a8 = display.newText("-", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a8:setFillColor(0.2)
    a8.anchorX = 0
    a8.anchorY = 0
    ...
    local options = {
         text = "TB.09 : FORMULIR RUJUKAN / PINDAH PASIEN",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
    ...
    local a9 = display.newText("-", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a9:setFillColor(0.2)
    a9.anchorX = 0
    a9.anchorY = 0
    ...
    local options = {
         text = "TB.10 : FORMULIR HASIL AKHIR PENGOBATAN DARI PASIEN TB PINDAHAN",
         x = composer.textTab1,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
