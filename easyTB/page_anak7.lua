...
function scene:create( event )
    ...
    local options = {
         text = "Vaksinasi Bacillus Calmette et Guerin (BCG)",
         x = composer.textTab1,
    ...
    y_now = teks4.y + teks4.height + 10
      ...
      local a4 = display.newText("2", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a4:setFillColor(0.2)
    a4.anchorX = 0
    a4.anchorY = 0
    scrollView:insert(a4)
