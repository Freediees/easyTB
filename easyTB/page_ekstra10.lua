...
--]]
	local options = {
 	...
 	local a1 = display.newText("Klasifikasi", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a1:setFillColor(0.2)
    a1.anchorX = 0
    a1.anchorY = 0
    scrollView:insert(a1)
     ...
     local a1 = display.newText("Cara penyebaran", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a1:setFillColor(0.2)
    a1.anchorX = 0
    a1.anchorY = 0
    scrollView:insert(a1)
     ...
     local options = {
         text = [[Eksogen:tuberklosis chancre, TB verukosa kutis, lupus vulgaris
Endogen:
- Langsung: skrofuloderma, TB orifisialis
- Hematogen: TB milier akut, abses TB metastatik, lupus vulgaris
- Limfatik: lupus vulgaris]],
         x = lebar/3,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
     ...
     local a1 = display.newText("Jenis bakteri", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a1:setFillColor(0.2)
    a1.anchorX = 0
    a1.anchorY = 0
    scrollView:insert(a1)
     ...
     local options = {
         text = [[Multibasiler: TB chancre, skrofuloderma, TB orifisialis, TB milier akut, TB gumatosa Pausibasiler: TB verukosa kutis, lupus]],
         x = lebar/3,
         y = y_now,
         font = used_font,
         fontSize = 12  * (display.contentWidth / 320),
