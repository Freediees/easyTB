...
--]]
	local options = {
     ...
     scrollView:insert(teks_produk_diskon);
 	 ...
 	 local a2 = display.newText("1.", composer.tab1,teks_produk_diskon.y + teks_produk_diskon.height + 10, used_font, 12  * (display.contentWidth / 320) )
    a2:setFillColor(0.2)
    a2.anchorX = 0
    a2.anchorY = 0
	...
	local options = {
		 text = "Biakan M. tb positif dari efusi perikardial atau jaringan",
         x = composer.textTab1,
	...
	local options = {
		 text = "BTA positif atau granuloma kaseosa pada spesimen biopsi perikardial",
         x = composer.textTab1,
         y = y_now,
         font = used_font_bold,
         fontSize = 12  * (display.contentWidth / 320),
	...
	local options = {
		 text = "PCR (+) pada spesimen biopsi pericardial.",
         x = composer.textTab1,
         y = y_now,
         font = used_font_bold,
         fontSize = 12  * (display.contentWidth / 320),
