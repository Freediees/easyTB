...
function scene:create( event )
	...
	local options = {
		 text = composer.text_tuberkulosisi_paru,
         x = lebar * 0.05,
    ...
    local a1 = display.newText("1.", composer.tab1,y_now, used_font_bold, 12  * (display.contentWidth / 320) )
    a1:setFillColor(0.2)
    a1.anchorX = 0
    a1.anchorY = 0
