...
function scene:create( event )
    ...
    scrollView:insert(a1)
     ...
     local a1 = display.newText("6.", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a1:setFillColor(0.2)
    a1.anchorX = 0
    a1.anchorY = 0
    scrollView:insert(a1)
    ...
    scrollView:insert(a1)
     ...
     local a1 = display.newText("8.", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a1:setFillColor(0.2)
    a1.anchorX = 0
    a1.anchorY = 0
    scrollView:insert(a1)
