...
function scene:create( event )
	...
	local options = {
		 text = "Tuberkulosis Paru pada Ibu Hamil dan Menyusui", 
         x = lebar * 0.05,
         y = 10,
         font = used_font_bold,
