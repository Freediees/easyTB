...
function scene:create( event )
	...
	local options = {
		 text = "Klasifikasi berdasarkan status HIV", x = lebar * 0.05,
         y = 10,
         font = used_font_bold,
	...
	local options = {
     ...
     local a3 = display.newText("3.", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a3:setFillColor(0.2)
    a3.anchorX = 0
    a3.anchorY = 0
    ...
    local options = {
		 text = "TB dengan status HIV tidak diketahui : ",
         x = composer.textTab1,
         y = y_now,
         font = used_font_bold,
         fontSize = 12  * (display.contentWidth / 320),
