...
function scene:create( event )
	...
	local options = {
		 text = "Kombinasi Dosis Tetap", x = lebar * 0.05,
         y = 10,
         font = used_font_bold,
	...
	local options = {
     ...
     y_now = teks6.y + teks6.height
      ...
      local logo = display.newImageRect( composer.imgDir.. "table4.png", 480, 340 ); 
