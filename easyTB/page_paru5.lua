...
function scene:create( event )
	...
	local options = {
		 text = "Tujuan dan Algoritma Pengobatan", x = lebar * 0.05,
         y = 10,
         font = used_font,
	...
	local options = {
     ...
     local a5 = display.newText("4.", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a5:setFillColor(0.2)
    a5.anchorX = 0
    a5.anchorY = 0
	...
	local options = {
     ...
     local a6 = display.newText("5.", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a6:setFillColor(0.2)
    a6.anchorX = 0
    a6.anchorY = 0
    ...
    local logo = display.newImageRect( composer.imgDir.. "chart1.png", 813, 281 ); 
