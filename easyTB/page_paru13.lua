...
function scene:create( event )
	...
	local options = {
		 text = "Klasifikasi TB Resisten Obat", x = lebar * 0.05,
         y = 10,
         font = used_font_bold,
