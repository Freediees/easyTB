...
function scene:create( event )
	...
	local options = {
		 text = "Klasifikasi Berdasarkan Hasil Pemeriksaan Bakteriologis dan Uji Resistensi Obat", x = lebar * 0.05,
         y = 10,
         font = used_font_bold,
    ...
    local options = {
         text = "TB paru apusan dahak positif :",
         x = composer.textTab1,
    ...
    local a3 = display.newText("i).", composer.tab2,y_now, used_font, 12  * (display.contentWidth / 320) )
    a3:setFillColor(0.2)
    a3.anchorX = 0
    a3.anchorY = 0
    ...
    local a4 = display.newText("ii).", composer.tab2,y_now, used_font, 12  * (display.contentWidth / 320) )
    a4:setFillColor(0.2)
    a4.anchorX = 0
    a4.anchorY = 0
	...
	local options = {
     ...
     local a6 = display.newText("3.", composer.tab1,y_now, used_font, 12  * (display.contentWidth / 320) )
    a6:setFillColor(0.2)
    a6.anchorX = 0
    a6.anchorY = 0
